...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_LCTL, KC_LALT, KC_LGUI, LSFT_T(KC_SPC), SC_SENT, MO(1), KC_DOT, KC_COMM
	),
	
	[1] = LAYOUT(
		KC_TRNS, KC_BRID, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_MRWD, KC_MPLY, KC_MFFD, KC_MUTE, KC_VOLD, KC_VOLU, 
		KC_TRNS, KC_GRV, KC_TILD, KC_HASH, KC_LBRC, KC_RBRC, KC_EXLM, KC_PPLS, KC_PMNS, KC_PEQL, KC_ASTR, KC_PERC, 
		KC_TRNS, KC_AT, KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_QUES, KC_SLSH, KC_PIPE, KC_BSLS, KC_LT, KC_GT, 
		KC_TRNS, KC_NO, KC_NO, KC_DLR, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS, KC_NO, KC_UNDS, KC_DQUO, KC_NO, KC_NO, KC_NO, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_COLN, KC_SCLN
	),

	[2] = LAYOUT(
		KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, 
		KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_HOME, KC_PGUP, 
		KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_END, KC_PGDN, 
